export default async function handler(req, res) {
  ...
  var prompt = [
    ...
    'Include: biting/stinging insects, ticks, arachnids, venomous snakes, dangerous reptiles,',
    'stinging or toxic plants, marine hazards, slugs, snails, stinging caterpillars, leeches.',
    '',
    ...
    'Prioritize surprising or lesser-known hazards.',
